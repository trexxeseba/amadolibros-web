...
- Estado: IMPLEMENTADO; controles locales y aceptación remota en curso. No afirmar que la aceleración esté desplegada. Sin merge, cambios en checkout ni escrituras de datos productivos. La aprobación y posterior verificación pública quedan pendientes de resultados reproducibles.
