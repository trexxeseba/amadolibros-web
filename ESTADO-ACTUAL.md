...
- Incidencia de ingreso: Seba recibe el 403 del panel después de llegar al enlace privado. Se prepara aceptación del JWT firmado de la cookie de aplicación cuando no hay cabecera Access; se mantienen firma, emisor, audiencia, vigencia y titular. El rechazo ofrece reingreso y una referencia cerrada sin datos de sesión. Causa exacta y primer ingreso exitoso aún no confirmados; las comprobaciones anónimas anteriores no cubrían el acceso real del titular.
