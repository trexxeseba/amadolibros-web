...
- **Ampliación de imagen para Google en preparación:** evidencia real de Product.image ausente y portada 426×500 en MLU651526046; [PR #336](https://github.com/trexxeseba/amadolibros-web/pull/336) corrige la ficha y la auditoría. Este PR #335 incorpora cuarto control Checkly de sólo lectura e independiente del recorrido visual, componente google_imagen, enlace exacto y motivo cerrado. Pruebas de ausencia/recuperación del script enviado al proveedor y webhook→SQLite→panel. Conexión y verificación remota pendientes al registrar este avance. No sustituye Search Console ni cubre todo el catálogo.
