...
- **Conexión Checkly, 2026-09-09:** Seba guardó la clave indicada y confirmó «LISTO». Acceso real verificado en la cuenta de su captura: plan trial, cero monitores previos. Se implementa la conexión pedida en recursos aislados: receptor dedicado, D1 exclusiva, webhook firmado y pruebas de entrega del proveedor antes de habilitar controles de lectura. Sólo el panel privado recibe la conexión; no hay merge, despliegue de la tienda, cambios en Access, escrituras de negocio ni contratación. Frecuencias iniciales compatibles con el presupuesto Hobby: dos API cada 10 minutos y un navegador cada 120 minutos, sin reintentos automáticos. La activación debe quedar respaldada por resultados reales, no por éxito del job únicamente.
