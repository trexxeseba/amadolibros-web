...
- **Solución final pedida 2026-09-09:** corrección de Product.image en PR #336 y control independiente en Checkly para MLU651526046. Detecta ausencia/URL inválida del dato de imagen y errores de respuesta, conserva fecha/enlace/recuperación en el panel. Cuarto control cada 120 minutos; máximo programado de navegador 744 ejecuciones en 31 días, además de 8.928 API. Sin contratación ni merge/despliegue de la tienda.
