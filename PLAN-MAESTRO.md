...
- **Estado:** primera entrega guardada en rama aislada; diagnóstico de conexiones 34222874855 exitoso el 2026-09-08. Panel todavía desactivado y actualización durable pendiente. Es una acción acotada autorizada expresamente; no se abre una segunda Gran Apuesta ni se reordena Merchant.
...
- **Evidencia:** `docs/admin-web/IMPLEMENTACION.md`, pruebas `functions/__tests__/admin-web.test.js`, `admin-web-connections.test.js` y [diagnóstico remoto](https://github.com/trexxeseba/amadolibros-web/actions/runs/34222874855). PR todavía no abierto.
...
- **Límites de autorización:** este avance no autoriza merge a `main`, despliegue productivo, migraciones, cambios de permisos productivos ni activación del panel. La aprobación de Seba debe referirse a la versión concreta ya validada. Checkout, home y sincronizador conservan su implementación.
