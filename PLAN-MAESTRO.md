...
- **Estado:** primera entrega en construcción en rama aislada desde `main` actualizado. Es una acción acotada autorizada expresamente; no se abre una segunda Gran Apuesta ni se reordena Merchant.
...
- **Evidencia:** `docs/admin-web/IMPLEMENTACION.md`, pruebas `functions/__tests__/admin-web.test.js` y PR de esta rama.
