...
test('Tarot y Biblias enlazan sus landings consolidadas sin crear URLs caníbales', () => {
  ...
  assert.doesNotMatch(source, /subcategoria=biblia|subcategoria=reina-valera/);
