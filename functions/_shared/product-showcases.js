...
const PADRES_FUERTES = Object.freeze({
  ...
  summary: Object.freeze([
    ...
    'La estructura en diez claves ayuda a convertir ideas generales sobre la paternidad en preguntas concretas para la vida diaria: cuánto tiempo compartimos, cómo reaccionamos ante un error, qué modelo ofrecemos con nuestras decisiones y de qué manera demostramos afecto sin renunciar a la responsabilidad adulta. Esa combinación de reflexión y orientación práctica permite leerlo de corrido o volver a capítulos específicos según la etapa familiar.',
