...
export const SEO_CATEGORIES = [
    ...
    },
    {
        ...
        classificationId: 'esoterismo-tarot', excludedClassificationIds: ['tarot-oraculos'],
        parentId: 'esoterismo-tarot', parentName: 'Tarot y oráculos', name: 'Libros de esoterismo',
        title: 'Libros de esoterismo en Uruguay | Amado Libros',
        h1: 'Libros de esoterismo en Uruguay',
        description: 'Libros de esoterismo en Uruguay: Cábala, astrología, magia, hermetismo, alquimia y espiritualidad. Explorá los temas y consultá la edición que estás buscando.',
        intro: 'Reunimos libros de Cábala, astrología, magia, hermetismo, alquimia, numerología y tradiciones espirituales. Podés explorar cada temática o consultar por una obra específica. Los mazos y manuales de tarot tienen accesos propios.',
