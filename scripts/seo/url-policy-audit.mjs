...
const cases = [
  ...
  { pattern: '/libros/{cat}?page=999999', url: `${BASE}/libros/psicologia?page=999999`, policy: 'NOT FOUND', expected: { status: 404, robotsHeader: 'noindex, nofollow' } },
  ...
  { pattern: '/shop', url: `${BASE}/shop`, policy: 'LEGACY 301', expected: { status: 301, location: '/catalogo' } },
  { pattern: '/mas-vendidos', url: `${BASE}/mas-vendidos`, policy: 'LEGACY 301', expected: { status: 301, location: '/catalogo' } },
